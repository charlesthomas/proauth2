...
i.e. user acceptance of oauth2 client's access request is **NOT** handled here. It's assumed that you will handle this *before* calling the request_authorization method.
